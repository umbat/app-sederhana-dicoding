...
object PlayersData {
    ...
    private val playersFullNames = arrayOf (
    ...
    private val playersPlaceOfBirth = arrayOf (
        "Warszawa, Poland",
    ...
    private val playersTimeOfBirth = arrayOf (
        "April 18, 1990",
        "August 12, 1999",
        "May 1, 1987",
        "January 26, 1991",
    ...
    get() {
        ...
        for (position in playersNames.indices){
            ...
            players.fullname = playersFullNames[position]
            players.placeofbirth = playersPlaceOfBirth[position]
